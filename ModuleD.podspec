...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lsw891227/ModuleD"
  ...
  s.source       = { :git => "https://github.com/lsw891227/ModuleD.git", :tag => s.version.to_s }
  ...
  s.source_files  = "ModuleD/ModuleD/**/*.{h,m,swift}"
